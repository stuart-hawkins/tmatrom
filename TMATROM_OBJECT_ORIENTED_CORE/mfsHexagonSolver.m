...
classdef mfsHexagonSolver < mfsSolver
    ...
    methods
        ...
        function val = getInnerRadius(self)
        ...
        function varargout = visualise(self,opts)
            ...
            % plot the shape
            obj = plot(real(a),imag(a),opts);
                                        
            % set return parameter if needed
            if nargout > 0
                varargout{1} = obj;
            end
