...
classdef regularwavefunctionexpansion < wavefunctionexpansion
    ...
    methods
        ...
        %-----------------------------------------
        % mtimes for scalar multiplication
        %-----------------------------------------

        function varargout = mtimes(obj,expansion)
            
            varargout{:} = obj.mtimes(expansion);
    ...
    methods(Access=protected)
        ...
        function [dx,dy] = internal_gradient(self,points)
            ...
            [dx,dy] = gradsumcof(points,self.origin,self.kwave,self.coefficients,'J');
